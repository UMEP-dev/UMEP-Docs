...
copyright = u'2018 - 2020, Fredrik Lindberg, Ting Sun, Sue Grimmond, Yihao Tang, Nils Wallenberg'
...
htmlhelp_basename = 'UMEPManualdoc'
...
latex_documents = [
    (master_doc, 'UMEPManual.tex', u'UMEP Manual Documentation',
...
man_pages = [
    (master_doc, 'umepmanual', u'UMEP Manual Documentation',
     [author], 1)
]
